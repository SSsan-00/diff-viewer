...
| テーマトグルのデザイン改善 | request | UI仕様 / 4.2 操作 | ☀️/🌙トグルを月と太陽スイッチ風にし、ライトは太陽ノブ＋雲、ダークはクレーター月＋星を表示する。ノブは回転しながら移動し、`prefers-reduced-motion` では抑制する。`reference/theme-toggle/day.png` / `reference/theme-toggle/night.png` を基準にする。 |
